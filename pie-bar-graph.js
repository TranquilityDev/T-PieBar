...
AngerChart = function(config, obj){
	var duration = 500;
	var self = this;
	...
	var pieColor = d3.scale.ordinal()
						.range(["#807dba","#e08214","#DF01D7",'#2ca02c', '#d62728']);
...
//			.attr("dy", ".75em")
	...
	function createLegend(data){
		...
		tr.append('td').append('svg').attr("width", '100').attr("height", '20')
...
DisgustChart = function(config, obj){
...
SadnessChart = function(config, obj){
